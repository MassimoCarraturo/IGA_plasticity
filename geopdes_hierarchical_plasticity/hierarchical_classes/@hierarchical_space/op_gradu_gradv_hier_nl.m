...
function varargout = op_gradu_gradv_hier_nl (hspu, hspv, hmsh, coeff, u)
  ...
  for ilev = 1:hmsh.nlevels
    ...
    if (hmsh.nel_per_level(ilev) > 0)
      ...
      K_lev = op_gradu_gradv_nl (spu_lev, spv_lev, hmsh.msh_lev{ilev}, coeff(eu(:, 1+sum(hmsh.nel_per_level(1:ilev-1)):sum(hmsh.nel_per_level(1:ilev)) ) ) );
