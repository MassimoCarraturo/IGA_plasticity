...
function varargout = op_u_v_hier_nl (hspu, hspv, hmsh, coeff, u, u_0)
  ...
  eu_0 =  hspace_eval_hmsh (u_0, hspu, hmsh);
  ...
  for ilev = 1:hmsh.nlevels
    ...
    if (hmsh.nel_per_level(ilev) > 0)
      ...
      M_lev = op_u_v_nl (spu_lev, spv_lev, hmsh.msh_lev{ilev}, coeff(eu(:, 1+sum(hmsh.nel_per_level(1:ilev-1)):sum(hmsh.nel_per_level(1:ilev)) ), eu_0(:, 1+sum(hmsh.nel_per_level(1:ilev-1)):sum(hmsh.nel_per_level(1:ilev)) ) ));
