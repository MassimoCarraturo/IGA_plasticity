...
problem_output.folder = 'GeoPDEs/output';
...
problem_data.x_begin = 4.5; %[mm]
problem_data.x_end = 5.5; %[mm]
...
problem_data.y_begin = 4.75;
problem_data.y_end = 5.25;
...
plot_data.time_steps_to_post_process = linspace(1,n_time_steps,n_time_steps);%[1,2,3,25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,425,450,475,500,...
...
plot_data.file_name = strcat(problem_output.folder, '/Patil_FullLayer_1000_nl_maxLevel10_3D_lumped_%d');
plot_data.file_name_mesh = strcat(problem_output.folder, '/Patil_FullLayer_1000_nl_maxLevel10_3D_lumped_mesh_%d');
plot_data.file_name_dofs = strcat(problem_output.folder, '/Patil_FullLayer_1000_nl_maxLevel10_3D_lumped_dofs');
plot_data.file_name_temp_plot = strcat(problem_output.folder, '/Patil_FullLayer_1000_nl_maxLevel10_3D_lumped_temperature_%d');
